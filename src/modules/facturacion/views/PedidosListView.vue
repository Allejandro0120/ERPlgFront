<!-- src/modules/facturacion/views/PedidosListView.vue -->
<template>
  <div class="w-100">
    <page-header-actions>
...
<script setup>
  ...
  import ConfirmarObservacionDialog from '@/modules/facturacion/components/pedido/ConfirmarObservacionDialog.vue'
  import PedidoDialog from '@/modules/facturacion/components/pedido/PedidoDialog.vue'
  import VentaSeleccionDialog from '@/modules/facturacion/components/VentaSeleccionDialog.vue'
