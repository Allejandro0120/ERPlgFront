...
export const infraestructuraService = {
   ...
   */
  getCedis: () =>
    withCache('cedis_list', () =>
      api.get('v1/infraestructure/distribution-centers'),
    ),
  ...
  getBodegasByCedi: IdDistributionCenter =>
    withCache(`cedis_${IdDistributionCenter}_warehouses`, () =>
      api.get(
        `v1/infraestructure/distribution-centers/${IdDistributionCenter}/warehouses`,
      ),
    ),
  ...
  getPasillosByZona: IdZone =>
    withCache(`zona_${IdZone}_pasillos`, () =>
      api.get(`infraestructure/zones/${IdZone}/aisles`),
    ),
  ...
  getUbicacionByEstante: IdEstante =>
    withCache(`estante_${IdEstante}_ubicacion`, () =>
      api.get(`infraestructure/shelves/${IdPasillo}/location`),
    ),
}
